...
/*
    ...
    Written by Joan Dolz and Taron 2009
...
//Arguments:  char axis
//Returns:    nothing
//Effect:     Run through the level array and render each block accordingly. 
...
//void drawMiniView1()
//Arguments:  char axis, int crd
//Returns:    nothing
//Effect:     Run through the level array and render each block accordingly to first minimap.
//	 		  Axis can be 'X', 'Y' or 'Z'.  crd ist the respective layer which is shown.
...
//Arguments:  char axis, int crd
//Returns:    nothing
//Effect:     Run through the level array and render each block accordingly to second minimap.
//			  Axis can be 'X', 'Y' or 'Z'. crd ist the respective layer which is shown.
...
public void keyPressed() {
 ...
 if(command == 0) {
    ...
    if(key == 'u') { //undo
    	if (undostep==maxundo){ //to redo the first undo
    		storeUndo();
    		undostep--;
    	}
    	if (undostep >= 0){
...
public void mouseReleased() {
	changing=false; //needed for undo reasons
}
...
//Arguments:	nothing
//Returns: 		nothing
//Effect: Converts loaded Infiniminer 1.3 Maps to 1.4/1.5 Maps
...
//Arguments:  none
//Returns:    nothing
//Effect:     stores the actual layer in undo[][][][]
...
//Arguments:  none
//Returns:    nothing
//Effect:     restores the undstep´th undo to the level
